...
var inside = function(incident) {
	if (this.nw.longitude <= incident.longitude && this.ne.longitude >= incident.longitude &&
...
exports.getNear = function(req, res) {
	...
	// defaulting the distance to 500 meters
	var distance = req.query.distance / 111.12 || 0.5 / 111.12;
